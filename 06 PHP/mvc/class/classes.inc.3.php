...
class MenuEntry {
	...
	function __toString(){
		return "<a class='nav-link ".$this->statut."'  href='".$this->lien."'>".$this->label."</a>";
	}
}
...
Class Blog extends Page{
	...
	function setMenu($menuTable){
		// $menuTable est un tableau d'instances de 'MenuEntry'
		$this->menu = '<div class="alert alert-primary" role="alert">
		<nav class="nav nav-pills nav-fill">';
		foreach($menuTable as $entreeMenu){
			// $entreeMenu est une instance de 'MenuEntry'
